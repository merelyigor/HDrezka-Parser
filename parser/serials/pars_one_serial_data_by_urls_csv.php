 ...
 */
function run_parser_save_one_serial_data($parser_serial_url, $path_file_serials_hash_folder)
{
    # парсинг одного сериала старт *******************>
    $result_serialize_arr = serialize((new ParserHD)->parse_raw_one_serials_data($parser_serial_url));
    # парсинг одного сериала старт *******************>
...
function main()
{
    ...
    $file = fopen("{$GLOBALS['path_repo_raw_data_serials_urls_csv_global']}", 'r');
    if (!file_exists($GLOBALS['path_repo_raw_data_serials_urls_csv_global'])) {
        Helper::error_print("
    какая то хуйня - нет файла с урлами сериалов в папке {$GLOBALS['path_repo_raw_data_serials_urls_csv_global']}
...
∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷
    ...
    Все урлы на спарсенные сериалы в файле ➤ 🚀({$GLOBALS['path_repo_raw_data_serials_urls_csv_global']})🚀
...
████████████████████████████████████████████████████████████████████████████████████████████████████████████████
    ...
    Счетчик количества спарсенных сериалов ➤ ✅🔥{$spinner_hourglass} ⟨{$count_of_the_number_of_currently_parsed_movies}⟩ {$spinner_shark}
...
";
                ...
                run_parser_save_one_serial_data($parser_serial_url, $path_file_serials_hash_folder);
...
Файлы с данными всех спарсенных сериалов тут ➤ 🚀({$GLOBALS['path_repo_output_serials_folder_global']}/$date_time_folder_name)🚀
