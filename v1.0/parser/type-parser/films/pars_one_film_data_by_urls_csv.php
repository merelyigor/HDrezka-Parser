 ...
 */
function run_parser_save_one_film_data($parser_film_url, $date_time_folder_name)
{
    # парсинг одного фильма старт *******************>
    $result_serialize_arr = serialize((new Parser)->parse_raw_one_films_data($parser_film_url));
    # парсинг одного фильма старт *******************>
...
");
        ...
        if ($file) {
            ...
            while (($line = fgetcsv($file, 0, ';')) !== false) {
                ...
                $how_much_is_left_until_the_end = Helper::how_much_time_is_left($second_parser_data['count_pars_movie'], $count_pars_movie, $sec);
                $how_much_is_left_until_the_end_text = Helper::sec_to_time($how_much_is_left_until_the_end);
                $how_much_is_left_until_the_end_2 = Helper::how_much_time_is_left_2($second_parser_data['count_pars_movie'], $count_pars_movie);
                ...
                $loader = Helper::loader(($second_parser_data['count_pars_movie'] < 90) ? $second_parser_data['count_pars_movie'] : 90);
                ...
                $parsed_urls_for_movies = Helper::num_word($second_parser_data['count_pars_movie'], ['урл', 'Урла', 'Урлов']);
...
∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷∷
    ...
    Все урлы на спарсенные фильмы в файле ➤ 🚀({$GLOBALS['path_repo_raw_data_global']}/{$GLOBALS['file_name_temporal_urls_global']})🚀
...
████████████████████████████████████████████████████████████████████████████████████████████████████████████████
    ...
    Счетчик количества спарсенных фильмов ➤ ✅🔥{$spinner_hourglass} ({$count_of_the_number_of_currently_parsed_movies} из {$second_parser_data['count_pars_movie']}) {$spinner_shark}
...
";
                ...
                run_parser_save_one_film_data($parser_film_url, $date_time_folder_name);
...
Время потраченное на парсинг фильмов ➤ ⌚ $execution_time_of_the_whole_script ⌚
    
    
    
Файлы с данными всех спарсенных фильмов тут ➤ 🚀({$GLOBALS['folder_name_films_global']}/{$date_time_folder_name})🚀
